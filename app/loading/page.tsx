  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] flex items-center justify-center overflow-hidden relative">
      ...
      <div className="relative z-10 bg-black border-0 rounded-xl">
        {/* 电脑屏幕框架 */}
        <div className="bg-transparent border-4 border-[#333333] rounded-xl p-3 sm:p-4 md:p-6 shadow-2xl w-[95vw] max-w-[700px] h-[45vh] max-h-[350px] sm:h-[48vh] sm:max-h-[380px] md:h-[50vh] md:max-h-[400px] mx-auto relative">
          
          {/* 控制按钮组 - 在显示屏框架的右下角 */}
          <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 md:bottom-4 md:right-4 z-20 flex flex-col items-end gap-1 sm:gap-1.5 md:gap-2">
            {/* 跳过按钮 */}
            <button
          ...
          {/* 屏幕内容区域 */}
          <div className="bg-black rounded-lg p-3 sm:p-4 md:p-6 font-mono w-full h-full flex flex-col relative">
            ...
            <div className="flex items-center gap-2 mb-4 pb-2 border-b border-[#333333] flex-shrink-0">
              ...
              <div className="text-[#e0e0e0] text-xs sm:text-sm md:text-sm ml-4">Terminal - yuanyuanyuan@resume</div>
            </div>
            
            {/* 终端内容区域 - 固定高度 */}
            <div className="flex-1 space-y-5 overflow-hidden">
              {/* 命令提示符 */}
              <div className="text-blue-400 text-lg sm:text-xl md:text-xl lg:text-2xl">
              ...
              <div className="h-22 w-full flex items-start">
                <div className="text-blue-400 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed w-full">
              ...
              {/* 系统状态 */}
        {currentIndex >= fullText.length && (
                <div className="text-blue-500 text-sm sm:text-base md:text-base animate-pulse">
                  <span className="text-blue-400">$</span> 
