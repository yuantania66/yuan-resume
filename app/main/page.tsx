  ...
  return (
    ...
    <div className="min-h-screen bg-background tech-grid relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* 渐变光晕 */}
        <div className="absolute inset-0 animate-[gradient-glow_12s_ease-in-out_infinite]"></div>
        
        {/* 浮动光点 */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400 rounded-full opacity-30 animate-[floating-lights_6s_ease-in-out_infinite]"></div>
        <div className="absolute top-1/3 right-1/4 w-1.5 h-1.5 bg-cyan-400 rounded-full opacity-40 animate-[floating-lights_8s_ease-in-out_infinite_1s]"></div>
        <div className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-purple-400 rounded-full opacity-50 animate-[floating-lights_7s_ease-in-out_infinite_2s]"></div>
        <div className="absolute top-2/3 right-1/3 w-2.5 h-2.5 bg-indigo-400 rounded-full opacity-30 animate-[floating-lights_9s_ease-in-out_infinite_3s]"></div>
        
        {/* 动态网格 */}
        <div className="absolute inset-0 grid grid-cols-20 grid-rows-20 animate-[grid-pulse_10s_ease-in-out_infinite]">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-bold text-balance">
                <div className="block md:hidden space-y-2">
                  <div className="hero-name">袁媛媛2</div>
